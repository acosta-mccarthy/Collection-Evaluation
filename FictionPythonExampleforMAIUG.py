...
try:
    conn = psycopg2.connect("dbname='xxx' user='xxxxxxxxxx' host='xxxxxxx' port='1032' password='xxxxxxxxxxxxx' sslmode='require'")
...
emailto = ['emccarthy@greenwichlibrary.org','xxxxxxxxx@greenwichlibrary.org']
conn.close()
